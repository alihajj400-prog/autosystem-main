    ...
    <>
      <div className="space-y-3">
        ...
        >
          ...
          <button className="absolute right-3 top-3 z-10 rounded-full bg-black/50 p-2 text-white opacity-70 transition hover:opacity-100">
          ...
          {images.length > 1 && (
            <>
              <Button
                variant="secondary"
                size="icon"
                className="absolute left-3 top-1/2 z-10 -translate-y-1/2 rounded-full bg-black/50 text-white opacity-80 shadow-lg hover:bg-black/70 hover:opacity-100"
              ...
              <Button
                variant="secondary"
                size="icon"
                className="absolute right-3 top-1/2 z-10 -translate-y-1/2 rounded-full bg-black/50 text-white opacity-80 shadow-lg hover:bg-black/70 hover:opacity-100"
      ...
      {fullscreen && (
        ...
        >
          <button className="absolute right-4 top-4 z-10 rounded-full bg-white/10 p-2 text-white transition hover:bg-white/20">
            <X className="h-6 w-6" />
          </button>
